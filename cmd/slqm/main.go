...
func main() {
	...
	// Explicitly bind to IPv4 — OpenWrt's iptables (fw3) and Go's dual-stack
	// behavior don't play well together, causing IPv4 connections to time out
	// when the server binds to an IPv6 dual-stack socket.
