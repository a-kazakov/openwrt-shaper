...
func main() {
	...
	// Listen on both IPv4 and IPv6. On OpenWrt, IPv6 works reliably while
	// IPv4 may be blocked by fw3/iptables. We open the port in iptables as
	// best-effort for IPv4 clients.
